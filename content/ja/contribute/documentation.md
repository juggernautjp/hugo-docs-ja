...
- contribute
date: "2017-02-01"
description: Documentation is an integral part of any open source project. The Hugo
  docs are as much a work in progress as the source it attempts to cover.
draft: true
keywords:
- docs
- documentation
